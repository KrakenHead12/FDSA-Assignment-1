...
void SinglyLinkedList<DT>::reverseRecursive(SinglyLinkedNode<DT> *prev, SinglyLinkedNode<DT> *curr)
{
    if (curr != NULL)
    {
        // make a recursive call such that:
        // 1. prev now becomes curr
        // 2. curr becomes curr.next
        // ........................... TASK 6 ............................

	reverseRecursive(curr,curr->next);

        // the next pointer of [curr] points to [prev]
        // .......................... TASK 7 .............................
	curr->next=prev;
    }
    else
...
void SinglyLinkedList<DT>::nthNodeFromEndRecursive(SinglyLinkedNode<DT> *head, int n)
{
    ...
    // make a recursive call such that head now becomes head.next
    // ......................... TASK 8 .........................
    ...
    if (counter == n)
    {
        // since we reached the required n'th position from the end,
        // update [tmp] to store [head]
        // ..................... TASK 10 ........................
	tmp=head;
    }
}
